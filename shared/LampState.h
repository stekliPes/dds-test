...
public:
     ...
     */
    eProsima_user_DllExport const eprosima::fastrtps::fixed_string<16>& LampID() const;

    /*!
     * @brief This function returns a reference to member LampID
     * @return Reference to member LampID
     */
    eProsima_user_DllExport eprosima::fastrtps::fixed_string<16>& LampID();
    /*!
...
private:
    ...
    eprosima::fastrtps::fixed_string<16> m_LampID;
    bool m_on;
